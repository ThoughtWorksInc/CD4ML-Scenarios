...
def write_metrics(evaluation_metrics, file_names):
...
def write_validation_info(validation_metrics,
    ...
    write_metrics(validation_metrics, file_names)

    print("Evaluation done with metrics {}.".format(
        json.dumps(validation_metrics)))

    make_validation_plot(true_validation_target, validation_predictions, track, file_names)
